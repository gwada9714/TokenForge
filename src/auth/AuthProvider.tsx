    ...
    const initializeAuthAndSession = async () => {
      try {
        ...
        try {
          ...
          logger.error(
            "Auth",
            "Erreur lors de l'initialisation de l'authentification, mais on continue",
            authError
          );
        }
        ...
        try {
          ...
          logger.error(
            "Auth",
            "Erreur lors de la configuration de la persistance, mais on continue",
            persistenceError
          );
        }
        ...
        const unsubscribe = onAuthStateChanged(
          ...
          async (user: User | null) => {
            ...
            try {
              ...
              logger.error(
                "Auth",
                "Erreur lors du démarrage de la session, mais on continue",
                error
              );
            }
            ...
            if (user) {
              ...
              logger.info("Auth", "Utilisateur authentifié", {
                userId: user.uid,
              });
            } else {
