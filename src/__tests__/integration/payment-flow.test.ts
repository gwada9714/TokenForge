...
describe("Payment Flow Integration", () => {
  ...
  describe("Hook Integration", () => {
    ...
    it("devrait mettre à jour le statut périodiquement", async () => {
      ...
      vi.spyOn(ethService, "getPaymentStatus").mockResolvedValueOnce(
  ...
  describe("Service Integration", () => {
    ...
    it("devrait valider les transactions", async () => {
      ...
      const isValid = await ethService.validateTransaction(
  ...
  describe("Error Recovery", () => {
    ...
    it("devrait limiter les tentatives de reprise", async () => {
      ...
      vi.spyOn(ethService as any, "sendTransaction").mockRejectedValue(
        new Error("Network error")
      );
