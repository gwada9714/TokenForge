...
const MockKYCConfig: React.FC<MockComponentProps> = ({
  onSubmit,
  isProcessing,
  error,
}) => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>
            <input type="checkbox" data-testid="id-document" defaultChecked />
            Document d'identité
          </label>
        </div>
        ...
        <div>
          <label>
            <input type="checkbox" data-testid="proof-address" defaultChecked />
        ...
        <div>
          <label>
            <input type="checkbox" data-testid="selfie" defaultChecked />
            Selfie
          </label>
        </div>
...
describe("KYCConfig Component", () => {
  ...
  it("met à jour le niveau de vérification correctement", async () => {
    ...
    await fireEvent.change(verificationLevelSelect, {
