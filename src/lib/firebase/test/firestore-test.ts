...
import { collection, addDoc, getDoc, getDocs, updateDoc, deleteDoc, query, where, limit, 
         writeBatch, runTransaction, doc, serverTimestamp, DocumentReference } from 'firebase/firestore';
...
export class FirestoreTest {
  ...
  static async testFirestoreInitialization(): Promise<any> {
    try {
      ...
      return {
        success: false,
        message: `Erreur lors de l'initialisation de Firestore: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testCreateDocument(): Promise<any> {
    try {
      ...
      return {
        success: false,
        message: `Erreur lors de la création du document: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testReadDocument(): Promise<any> {
    try {
      ...
      return {
        success: false,
        message: `Erreur lors de la lecture du document: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testUpdateDocument(): Promise<any> {
    try {
      ...
      return {
        success: false,
        message: `Erreur lors de la mise à jour du document: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testDeleteDocument(): Promise<any> {
    try {
      ...
      return {
        ...
        message: (existedBefore && !existsAfter)
      ...
      return {
        success: false,
        message: `Erreur lors de la suppression du document: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testQueryCollection(): Promise<any> {
    try {
      ...
      const results = querySnapshot.docs.map(doc => {
        const data = doc.data() as { type: string; name: string; value: number };
        return { id: doc.id, ...data };
      });
      
      return {
        success: results.length > 0 && results.every(doc => doc.type === 'even'),
      ...
      return {
        success: false,
        message: `Erreur lors de l'exécution de la requête: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testFirestoreBatch(): Promise<any> {
    try {
      ...
      const allProcessed = results.every(result => result.data.batchProcessed === true);
      ...
      return {
        success: false,
        message: `Erreur lors de l'exécution du batch: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
  ...
  static async testFirestoreTransaction(): Promise<any> {
    try {
      ...
      return {
        success: finalDocAData.transactionProcessed === true && 
      ...
      return {
        success: false,
        message: `Erreur lors de l'exécution de la transaction: ${error instanceof Error ? error.message : String(error)}`,
        error: error
      };
    }
  }
