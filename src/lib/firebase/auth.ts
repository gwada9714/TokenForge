...
export class FirebaseAuthService {
  ...
  private async ensureInitialized(): Promise<Auth> {
    if (!this.auth) {
      try {
        ...
        logger.error({
          category: 'FirebaseAuth',
          message: 'Erreur lors de l\'initialisation du service d\'authentification',
   ...
   */
  public async updateProfile(profileData: { displayName?: string; photoURL?: string }): Promise<void> {
    try {
