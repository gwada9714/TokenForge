...
const AppSimple = () => {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <p>Cette version simplifiée ne dépend d'aucune bibliothèque externe à part React Router.</p>
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={
            <div>
              ...
              <div style={{ 
                ...
                <p>Si cette page s'affiche correctement, le problème est lié aux dépendances externes.</p>
              </div>
            </div>
          } />
          ...
          <Route path="/test" element={
            <div>
              <h2>Page de test</h2>
              <p>Cette page s'affiche si le routage fonctionne correctement.</p>
              <button 
