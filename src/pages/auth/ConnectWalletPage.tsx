      ...
      >
        <Paper elevation={3} sx={{ p: 4, width: "100%", textAlign: "center" }}>
          <AccountBalanceWalletIcon
            sx={{ fontSize: 64, mb: 2, color: "primary.main" }}
          />
          ...
          {isAttempting ? (
            ...
            <>
              <Typography variant="body1" color="text.secondary" paragraph>
                Pour accéder à cette fonctionnalité, vous devez connecter votre
                wallet Ethereum. Cliquez sur le bouton ci-dessous pour vous
                connecter via MetaMask ou un autre wallet Web3.
              </Typography>
