  ...
  return (
    <AuthGuard requireAuth={true} fallbackUrl="/auth-demo">
      <Helmet>
        ...
        <meta name="description" content="Page protégée nécessitant une authentification" />
      </Helmet>
        ...
        <Box sx={{ my: 4 }}>
          ...
          <Paper sx={{ p: 4, mb: 4 }}>
            <Typography variant="h6" gutterBottom>
              Bienvenue, {user?.displayName || user?.email || 'Utilisateur Anonyme'}!
            </Typography>
            <Typography paragraph>
              Cette page est protégée et n&apos;est accessible qu&apos;aux utilisateurs authentifiés.
              Si vous voyez ce contenu, cela signifie que vous êtes correctement authentifié.
            </Typography>
            <Typography paragraph>
