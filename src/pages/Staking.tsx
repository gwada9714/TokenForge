...
const StakingPage = () => {
  ...
  const platformTokenAddress = chain?.id
    ? getContractAddress("PLATFORM_TOKEN", chain.id)
    : null;
    ...
    return (
      <Container maxWidth="xl" sx={{ py: 4 }}>
        <Alert severity="error" sx={{ mb: 3 }}>
          Le staking n'est pas disponible sur ce réseau. Veuillez changer de
          réseau.
        </Alert>
      </Container>
    );
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="body1" sx={{ mb: 2 }}>
          Stake your TokenForge tokens to earn rewards and participate in
          platform governance.
        </Typography>
      </Box>
