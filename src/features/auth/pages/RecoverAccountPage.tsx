        ...
        <form onSubmit={handleVerificationSubmit} className="space-y-6">
            <div>
                <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                    Un code de vérification a été envoyé à <strong>{email}</strong>. Veuillez entrer ce code ci-dessous.
                </p>
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    type="submit"
                    disabled={isSubmitting}
                    className={`flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''
                        }`}
                >
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8">
                    <div>
                        ...
                        {!success && (
                            <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                                Réinitialisez votre mot de passe ou récupérez l'accès à votre compte
                            </p>
                        )}
                    </div>
