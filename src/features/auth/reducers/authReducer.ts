  ...
  switch (action.type) {
    ...
    case AUTH_ACTIONS.UPDATE_PROFILE_SUCCESS:
      ...
      return {
        ...
        canCreateToken: action.payload.canCreateToken !== undefined ? action.payload.canCreateToken : state.canCreateToken,
        canUseServices: action.payload.canUseServices !== undefined ? action.payload.canUseServices : state.canUseServices
      };
