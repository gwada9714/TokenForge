...
describe('FirebaseService', () => {
  ...
  describe('signIn', () => {
    ...
    it('should handle invalid email error', async () => {
      ...
      await expect(firebaseService.signIn('invalid-email', 'password123'))
    ...
    it('should handle disabled user error', async () => {
      ...
      await expect(firebaseService.signIn('test@example.com', 'password123'))
        .rejects.toThrow(expect.objectContaining({
  ...
  describe('signUp', () => {
    ...
    it('should handle email already in use error', async () => {
      ...
      await expect(firebaseService.signUp('existing@example.com', 'password123'))
        .rejects.toThrow(expect.objectContaining({
  ...
  describe('resetPassword', () => {
    it('should successfully send reset password email', async () => {
      ...
      await expect(firebaseService.resetPassword('test@example.com')).resolves.not.toThrow();
    });
    ...
    it('should handle invalid email error', async () => {
      ...
      await expect(firebaseService.resetPassword('invalid-email'))
        .rejects.toThrow(expect.objectContaining({
          code: AuthErrorCode.INVALID_EMAIL
        }));
    });
