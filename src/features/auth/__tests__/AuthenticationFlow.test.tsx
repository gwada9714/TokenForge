...
describe('AuthenticationFlow Integration Tests', () => {
  ...
  describe('Login Process', () => {
    ...
    it('should display error message on login failure', async () => {
      ...
      mockUseTokenForgeAuth.actions.login.mockRejectedValueOnce(new Error(errorMessage));
      const user = userEvent.setup({ delay: null });
  ...
  describe('Wallet Connection', () => {
    ...
    it('should handle wallet connection', async () => {
      mockUseTokenForgeAuth.actions.connectWallet.mockResolvedValueOnce(undefined);
      const user = userEvent.setup({ delay: null });
  ...
  describe('Network Switching', () => {
    ...
    it('should handle network switch', async () => {
      mockUseTokenForgeAuth.walletState.isCorrectNetwork = false;
      mockUseTokenForgeAuth.actions.switchNetwork.mockResolvedValueOnce(undefined);
      const user = userEvent.setup({ delay: null });
