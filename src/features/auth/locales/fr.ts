...
export const authMessages = {
  errors: {
    ...
    [AuthErrorCode.GOOGLE_SIGN_IN_ERROR]:
    ...
    [AuthErrorCode.SESSION_CHECK_ERROR]:
      "Erreur lors de la vérification de la session.",
    [AuthErrorCode.SESSION_REFRESH_ERROR]:
