...
const TokenomicsDesignerPage: React.FC = () => {
  ...
  const handleAllocationChange =
    (index: number, field: keyof TokenAllocation) =>
    (
      event:
  ...
  const addAllocation = () => {
    const newColor =
      allocationColors[
        tokenomicsData.allocations.length % allocationColors.length
      ];
    setTokenomicsData({
      ...tokenomicsData,
      allocations: [
        ...
        {
          name: `Allocation ${tokenomicsData.allocations.length + 1}`,
          percentage: 0,
          lockupPeriod: 0,
          vestingPeriod: 0,
          color: newColor,
            ...
            {activeTab === 0 && (
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Choisissez un modèle de tokenomics prédéfini comme point de
                    départ.
                  </Typography>
            ...
            {activeTab === 1 && (
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Définissez comment les tokens seront distribués entre les
                  ...
                  {totalAllocation !== 100 && (
                    ...
                    >
                      {totalAllocation > 100
                        ...
                        : `Le total des allocations est de ${totalAllocation}%. Il reste ${
                            100 - totalAllocation
                          }% à allouer.`}
                    </Alert>
                  )}
                        ...
                        <Grid container spacing={3}>
                          <Grid item xs={12} sm={6} md={3}>
                            <TextField
                              ...
                              onChange={(e) =>
                                handleAllocationChange(index, "name")(e)
                              }
                            />
                          </Grid>
                          <Grid item xs={12} sm={6} md={3}>
                            <Box sx={{ width: "100%" }}>
                              ...
                              <Slider
                                ...
                                onChange={(e, value) =>
                                  handleAllocationChange(index, "percentage")(
                                    e,
                                    value
                                  )
                                }
                          ...
                          <Grid item xs={12} sm={6} md={2}>
                            <Box sx={{ width: "100%" }}>
                              ...
                              <Slider
                                ...
                                onChange={(e, value) =>
                                  handleAllocationChange(index, "lockupPeriod")(
                                    e,
                                    value
                                  )
                                }
            ...
            {activeTab === 2 && (
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Visualisez la répartition de vos tokens et la libération
                    ...
                    {tokenomicsData.allocations.map((allocation, index) => (
                      <Grid item xs={12} sm={6} md={4} key={index}>
                        ...
                        >
                          ...
                          <Typography variant="body2" color="text.secondary">
                            {parseFloat(tokenomicsData.totalSupply) *
                              (allocation.percentage / 100)}{" "}
                            tokens
                          </Typography>
                          <Typography variant="body2" color="text.secondary">
                            Lockup: {allocation.lockupPeriod} mois | Vesting:{" "}
                            {allocation.vestingPeriod} mois
                          </Typography>
                        </Paper>
                      </Grid>
                    ))}
            ...
            {activeTab === 3 && (
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Simulez différents scénarios pour évaluer la performance de
                    votre tokenomics.
                  </Typography>

                  <Alert severity="info" sx={{ mb: 3 }}>
                    Cette fonctionnalité sera disponible prochainement. Elle
                    permettra de simuler différents scénarios de marché et
                    d'évaluer l'impact sur le prix et la liquidité de votre
                    token.
                  </Alert>
                </Grid>
