...
import { Search, CheckCircle, Cancel, Flag } from "@mui/icons-material";
...
export const MarketplaceManagementPage: React.FC = () => {
  ...
  const [_selectedTemplate, setSelectedTemplate] = useState<number | null>(
    null
  );
  ...
  const pendingTemplates = [
    {
      ...
      status: "pending",
      description:
        "Template optimisé pour les projets DeFi avec mécanismes de farming et staking intégrés. Inclut des fonctionnalités de récompense automatique et de verrouillage de liquidité.",
    ...
    },
    {
      ...
      status: "pending",
      description:
        "Template spécialement conçu pour les tokens de jeux blockchain avec fonctionnalités d'items NFT et économie in-game.",
    ...
    },
    {
      ...
      status: "pending",
      description:
        "Template pour tokens de gouvernance avec système de vote, délégation et propositions intégrées.",
  ...
  const commentsToModerate = [
    {
      ...
      comment:
        "Ce template est exactement ce que je cherchais ! Très facile à utiliser et bien documenté.",
      rating: 5,
      date: "1 Mars 2025",
      status: "pending",
      flags: 0,
    },
    {
      ...
      comment:
        "Attention, ce template contient des vulnérabilités ! J'ai trouvé une faille dans la fonction de distribution des récompenses.",
      rating: 2,
    ...
    },
    {
      ...
      comment:
        "Contactez-moi sur Telegram @scammer pour un template gratuit bien meilleur que celui-ci !",
      rating: 1,
                      ...
                      <Box sx={{ p: 3 }}>
                        ...
                        >
                          <Button
                            size="small"
                            onClick={() =>
                              handleOpenTemplateDialog(template.id)
                            }
                          >
                            Voir détails
                          </Button>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper sx={{ p: 3, textAlign: "center" }}>
                <Typography variant="h4" color="primary">
                  {
                    salesStats.monthlySales[salesStats.monthlySales.length - 1]
                      .sales
                  }
                </Typography>
                <Typography variant="body2" color="textSecondary">
