...
describe('TokenDeploymentService', () => {
  ...
  const mockWalletAddress = '0x742d35Cc6634C0532925a3b844Bc454e4438f44e' as `0x${string}`;
  ...
  describe('deployToken', () => {
    ...
    it('should calculate correct deployment fee for BSC', async () => {
      const result = await service.deployToken('bsc', mockConfig, mockWalletAddress);
    ...
    it('should handle deployment errors gracefully', async () => {
      ...
      const result = await service.deployToken('ethereum', mockConfig, mockWalletAddress);
