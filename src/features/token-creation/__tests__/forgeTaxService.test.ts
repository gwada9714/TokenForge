...
describe('ForgeTaxService', () => {
  ...
  const mockForgeWallet = '0x742d35Cc6634C0532925a3b844Bc454e4438f44e' as `0x${string}`;
  const mockTreasuryWallet = '0x742d35Cc6634C0532925a3b844Bc454e4438f44f' as `0x${string}`;
  ...
  describe('calculateTaxDistribution', () => {
    it('should calculate correct tax distribution for base tax', () => {
      ...
      const { forgeAmount, treasuryAmount, creatorAmount } = service.calculateTaxDistribution(
        amount,
        customTaxRate
      );
    ...
    it('should cap custom tax at maximum rate', () => {
      ...
      const { creatorAmount } = service.calculateTaxDistribution(amount, customTaxRate);
  ...
  describe('validateTaxPayment', () => {
    it('should return false for failed transactions', async () => {
      ...
      const result = await service.validateTaxPayment(mockReceipt, BigInt(1000));
