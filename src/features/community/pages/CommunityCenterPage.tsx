...
export const CommunityCenterPage: React.FC = () => {
    ...
    const announcements = [
        {
            ...
            content: "Nous sommes ravis d'annoncer le lancement de TokenForge v2.5 avec de nouvelles fonctionnalités: support multi-chain étendu, outils de tokenomics avancés et interface utilisateur améliorée. Découvrez toutes les nouveautés dès maintenant!",
        ...
        },
        {
            ...
            content: "Ne manquez pas notre prochain webinaire sur les tokenomics avancés, animé par Dr. Sarah Chen, économiste blockchain. Apprenez à concevoir des modèles économiques durables pour vos projets. Inscrivez-vous dès maintenant!",
    ...
    const discussions = [
        {
            id: 3,
            title: "Quelle est la meilleure stratégie de staking pour un token de gouvernance?",
            content: "Je développe un token de gouvernance pour une DAO et je cherche des conseils sur la configuration optimale du staking. Quels paramètres recommandez-vous pour encourager la participation à long terme tout en maintenant une liquidité suffisante?",
        ...
        },
        {
            ...
            content: "Je viens de déployer mon token sur 4 blockchains différentes (Ethereum, BSC, Polygon et Avalanche) en utilisant TokenForge. Je partage mon expérience, les défis rencontrés et les solutions trouvées. N'hésitez pas à poser vos questions!",
        ...
        },
        {
            ...
            content: "Je souhaite protéger mon token contre les manipulations de marché par les gros détenteurs. Quels sont vos conseils pour configurer les limites de transaction et de détention? Quels pourcentages recommandez-vous?",
            author: "TokenSecure",
            authorRole: "Membre",
            authorLevel: 1,
    ...
    const polls = [
        {
            id: 6,
            title: "Quelle blockchain souhaitez-vous voir ajoutée en priorité à TokenForge?",
        ...
        {
            id: 7,
            title: "Quelle fonctionnalité souhaitez-vous voir développée en priorité?",
            author: "Équipe Produit",
            authorRole: "Officiel",
    ...
    const topAmbassadors = [
        {
            ...
            contributions: "A créé plus de 30 tutoriels et organisé 5 webinaires éducatifs."
        },
        {
            id: 9,
            name: "Alex T.",
            ...
            contributions: "Développeur de 12 templates personnalisés et contributeur technique actif."
        },
        {
            id: 10,
            name: "Sophia L.",
            ...
            contributions: "A organisé 8 événements locaux et gère plusieurs communautés en Asie."
        }
    ];
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 6 }}>
            ...
            <Typography variant="h6" align="center" color="textSecondary" paragraph sx={{ mb: 6 }}>
                Rejoignez la communauté TokenForge, partagez vos expériences et apprenez des autres membres
            </Typography>
                                ...
                                <Card key={discussion.id} sx={{ mb: 3 }}>
                                    <CardContent>
                                        <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 2 }}>
                                            <Avatar sx={{ mr: 2 }}>{discussion.author.charAt(0)}</Avatar>
                                            <Box sx={{ flexGrow: 1 }}>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                    <IconButton
                                                        size="small"
                                                        color={likedPosts.includes(discussion.id) ? "primary" : "default"}
                                                        onClick={() => handleLike(discussion.id)}
                                                    >
                                                        <ThumbUp fontSize="small" />
                                                    </IconButton>
                                                    <Typography variant="body2">
                                                        {discussion.likes + (likedPosts.includes(discussion.id) ? 1 : 0) - (dislikedPosts.includes(discussion.id) ? 1 : 0)}
                                                    </Typography>
                                                    <IconButton
                                                        size="small"
                                                        color={dislikedPosts.includes(discussion.id) ? "primary" : "default"}
                    ...
                    {tabValue === 1 && (
                        <>
                            {announcements.map((announcement) => (
                                <Card key={announcement.id} sx={{ mb: 3, border: announcement.important ? '1px solid' : 'none', borderColor: 'primary.main' }}>
                                    {announcement.image && (
                                        <CardMedia
                                            component="img"
                                            height="200"
                                    ...
                                    <CardContent>
                                        ...
                                        <List>
                                            {poll.options.map((option, index) => {
                                                ...
                                                const isUserVote = poll.userVoted && poll.userVotedOption === index;
                                                            ...
                                                            >
                                                                <Box
                                                                    sx={{
                                                                        ...
                                                                        height: '100%',
                                                                        width: `${percentage}%`,
                                                                        bgcolor: isUserVote ? 'primary.main' : 'primary.light',
                                                                        borderRadius: 1,
                                                                    }}
                                                                />
                                                            </Box>
                    ...
                    <Paper sx={{ p: 3, mb: 4 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                            ...
                            <Box>
                                ...
                                <Chip size="small" label="Niveau 1" color="primary" sx={{ mt: 0.5 }} />
                            </Box>
                        </Box>
                        <Divider sx={{ my: 2 }} />
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={4}>
                                <Box sx={{ textAlign: 'center' }}>
                                    ...
                                    <Typography variant="body2" color="textSecondary">Discussions</Typography>
                                </Box>
                            </Grid>
                            <Grid item xs={4}>
                                <Box sx={{ textAlign: 'center' }}>
                                    <Typography variant="h6">12</Typography>
                                    <Typography variant="body2" color="textSecondary">Commentaires</Typography>
                                </Box>
                            </Grid>
                            <Grid item xs={4}>
                                <Box sx={{ textAlign: 'center' }}>
