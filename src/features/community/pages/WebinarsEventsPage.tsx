    ...
    const upcomingWebinars = [
        {
            ...
            participants: 156,
            language: "Français",
            description: "Découvrez les principes avancés de tokenomics et apprenez à concevoir des modèles économiques durables pour vos projets blockchain. Ce webinaire couvrira les mécanismes d'incitation, les modèles de distribution et les stratégies anti-inflation.",
        ...
        },
        {
            ...
            participants: 203,
            language: "Français",
            description: "Protégez vos tokens et vos utilisateurs contre les vulnérabilités courantes. Ce webinaire technique explorera les meilleures pratiques de sécurité pour les smart contracts, les audits de code et les mécanismes de protection anti-rugpull.",
        ...
        },
        {
            ...
            participants: 178,
            language: "Français",
            description: "Apprenez à promouvoir efficacement votre token et à construire une communauté engagée. Ce webinaire couvrira les stratégies de marketing spécifiques à l'écosystème crypto, la gestion communautaire et les techniques de growth hacking.",
        ...
        },
        {
            ...
            participants: 124,
            language: "Français",
            description: "Explorez les avantages et défis du déploiement multi-chain. Ce webinaire technique vous guidera à travers le processus de déploiement de tokens sur plusieurs blockchains et la gestion efficace des actifs cross-chain.",
    ...
    const upcomingEvents = [
        {
            ...
            participants: 500,
            description: "La plus grande conférence TokenForge de l'année. Rejoignez-nous pour trois jours de présentations, ateliers et networking avec les leaders de l'industrie blockchain. Découvrez en avant-première les nouvelles fonctionnalités de la plateforme.",
        ...
        },
        {
            ...
            participants: 350,
            description: "Participez à notre hackathon de 48 heures et développez des solutions DeFi innovantes avec TokenForge. Prix total de 50 000€ en tokens et opportunités de financement pour les meilleurs projets.",
        ...
        },
        {
            ...
            participants: 120,
            description: "Rencontrez la communauté TokenForge de Montréal lors de cette soirée networking. Au programme: présentations de projets locaux, discussions sur les tendances blockchain et opportunités de collaboration.",
    ...
    const pastWebinars = [
        {
            ...
            views: 1245,
            language: "Français",
            description: "Découvrez les fonctionnalités de base de TokenForge et apprenez à créer votre premier token en moins de 15 minutes. Ce webinaire d'introduction est parfait pour les débutants.",
        ...
        },
        {
            ...
            views: 876,
            language: "Français",
            description: "Apprenez à configurer des mécanismes de staking efficaces pour votre token. Ce webinaire couvre les différents modèles de récompenses, les périodes de lock et les stratégies d'incitation à long terme.",
        ...
        },
        {
            ...
            views: 932,
            language: "Français",
            description: "Maîtrisez les concepts de liquidité et apprenez à gérer efficacement les pools de liquidité pour votre token. Ce webinaire technique explore les stratégies d'optimisation et les mécanismes auto-LP.",
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 6 }}>
            ...
            <Typography variant="h6" align="center" color="textSecondary" paragraph sx={{ mb: 6 }}>
                Restez informé et développez vos compétences avec nos webinaires et événements exclusifs
            </Typography>
                        ...
                        <DialogContent>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={6}>
                                    <Box
                                        component="img"
                                        src={upcomingWebinars.find(w => w.id === selectedEvent)?.image}
                                        alt={upcomingWebinars.find(w => w.id === selectedEvent)?.title}
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        <Typography variant="body2" paragraph>
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.description}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                        <Typography variant="subtitle2">Date et heure:</Typography>
                                        <Typography variant="body2">
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.date} à {upcomingWebinars.find(w => w.id === selectedEvent)?.time}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                        <Typography variant="subtitle2">Durée:</Typography>
                                        <Typography variant="body2">
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.duration}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                        <Typography variant="subtitle2">Présentateur:</Typography>
                                        <Typography variant="body2">
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.speaker}, {upcomingWebinars.find(w => w.id === selectedEvent)?.speakerRole}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                        <Typography variant="subtitle2">Langue:</Typography>
                                        <Typography variant="body2">
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.language}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 2 }}>
                                        <Typography variant="subtitle2">Participants:</Typography>
                                        <Typography variant="body2">
                                            {upcomingWebinars.find(w => w.id === selectedEvent)?.participants} inscrits
                                        </Typography>
                                    </Box>
                                    <Box>
                                        {upcomingWebinars.find(w => w.id === selectedEvent)?.tags.map((tag) => (
                                            <Chip
                                                key={tag}
                                                label={tag}
                                                size="small"
                        ...
                        <DialogContent>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={6}>
                                    <Box
                                        component="img"
                                        src={upcomingEvents.find(e => e.id === selectedEvent)?.image}
                                        alt={upcomingEvents.find(e => e.id === selectedEvent)?.title}
                                        sx={{ width: '100%', borderRadius: 1 }}
                                    />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        <Typography variant="body2" paragraph>
                                            {upcomingEvents.find(e => e.id === selectedEvent)?.description}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                    ...
                                    <Box sx={{ mb: 1 }}>
                                        ...
                                        <Typography variant="body2">
                                            {upcomingEvents.find(e => e.id === selectedEvent)?.location}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mb: 1 }}>
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        <Typography variant="subtitle2">Participants:</Typography>
                                        <Typography variant="body2">
                                            {upcomingEvents.find(e => e.id === selectedEvent)?.participants} participants attendus
                                        </Typography>
                                    </Box>
                                    <Box>
                                        {upcomingEvents.find(e => e.id === selectedEvent)?.tags.map((tag) => (
                                            <Chip
                                                key={tag}
                                                label={tag}
                                                size="small"
