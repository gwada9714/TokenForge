          ...
          {tokens.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Créez votre premier token en quelques minutes avec notre assistant de création.
              </p>
              <Link
                to="/create-token"
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {tokens.map((token) => (
                      <tr key={token.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {token.status === 'pending' ? (
                            ...
                            <div>
                              ...
                              <div className={`text-xs ${token.change24h > 0
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${token.status === 'active'
