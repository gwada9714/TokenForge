                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {blockchains.map((chain) => (
                      ...
                      >
                        <div
                          className={`w-16 h-16 ${chain.color} rounded-full flex items-center justify-center text-white text-2xl mb-4`}
                        >
                          {chain.icon}
                        </div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            Permet de créer de nouveaux tokens après le
                            déploiement
                          </p>
                        </div>
                ...
                <div>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Votre token est prêt à être déployé. Vérifiez les
                      informations ci-dessous avant de confirmer.
                    </p>
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md text-blue-800 dark:text-blue-200 mb-6">
                      <p>
                        Des frais de déploiement s'appliqueront en fonction de
                  ...
                  <div className="flex justify-between">
                    ...
                    <button className="px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                      Déployer le token
                    </button>
                  </div>
                </div>
