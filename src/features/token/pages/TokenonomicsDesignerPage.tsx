...
export const TokenonomicsDesignerPage: React.FC = () => {
    ...
    const [distribution, setDistribution] = useState<TokenDistribution[]>([
        { label: 'Équipe', percentage: 15, color: '#4C51BF', lockup: { duration: 24, initialRelease: 0 } },
        { label: 'Investisseurs', percentage: 20, color: '#2B6CB0', lockup: { duration: 12, initialRelease: 10 } },
        { label: 'Réserve', percentage: 10, color: '#2C7A7B', lockup: { duration: 36, initialRelease: 0 } },
        { label: 'Liquidité', percentage: 25, color: '#38A169', lockup: { duration: 6, initialRelease: 100 } },
        { label: 'Marketing', percentage: 10, color: '#DD6B20', lockup: { duration: 12, initialRelease: 25 } },
        { label: 'Communauté', percentage: 20, color: '#C53030', lockup: { duration: 0, initialRelease: 100 } },
    ]);
    ...
    const addAllocation = () => {
        const colors = ['#4C51BF', '#2B6CB0', '#2C7A7B', '#38A169', '#DD6B20', '#C53030', '#805AD5', '#D69E2E'];
    ...
    const updateAllocation = (index: number, field: string, value: any) => {
        ...
        if (field === 'percentage') {
            newDistribution[index].percentage = Math.min(100, Math.max(0, Number(value)));
        } else if (field === 'label') {
            ...
            if (lockupField === 'duration') {
                ...
                newDistribution[index].lockup!.initialRelease = Math.min(100, Math.max(0, Number(value)));
            }
        }
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div>
                            ...
                            <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
                                Concevez et visualisez la distribution et le vesting de vos tokens
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setTokenParams({ ...tokenParams, maxSupply: e.target.value })}
                                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setTokenParams({ ...tokenParams, decimals: Number(e.target.value) })}
                                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                                ...
                                <div className={`text-center font-medium ${totalPercentage === 100
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => updateAllocation(index, 'lockup.duration', e.target.value)}
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => updateAllocation(index, 'lockup.initialRelease', e.target.value)}
                                                        className="w-full px-3 py-1 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white"
                                                    />
                                                </div>
                                            </div>
