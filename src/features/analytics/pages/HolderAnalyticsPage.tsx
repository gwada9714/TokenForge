                        ...
                        <div className="flex flex-wrap items-center justify-between">
                            <div className="flex space-x-4 mb-2 sm:mb-0">
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md ${timeframe === '24h'
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md ${timeframe === '7d'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md ${timeframe === '30d'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-md ${timeframe === 'all'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'
                                        }`}
                                >
                        ...
                        <div className="space-y-4">
                            <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20 dark:border-yellow-600">
                                ...
                                <p className="mt-1 text-yellow-700 dark:text-yellow-200">
                                    Les 5 principaux détenteurs possèdent 38.5% du supply total. Cela peut
                                    représenter un risque de volatilité en cas de vente importante.
                                </p>
                            </div>
                            <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20 dark:border-green-600">
                                ...
                                <p className="mt-1 text-green-700 dark:text-green-200">
                                    Le nombre de détenteurs augmente de manière constante (+12.5% sur 30 jours),
                                    indiquant un intérêt croissant pour le token.
                                </p>
                            </div>
                            <div className="p-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-600">
                                ...
                                <p className="mt-1 text-blue-700 dark:text-blue-200">
                                    Envisagez des initiatives communautaires pour encourager une distribution
                                    plus large des tokens et réduire la concentration.
                                </p>
                            </div>
                        </div>
                    </div>
