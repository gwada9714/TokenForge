    ...
    const legalTemplates: LegalTemplate[] = [
        {
            ...
            description: 'Modèle complet de conditions générales pour la vente de tokens, incluant les clauses de limitation de responsabilité, de KYC/AML et de restrictions géographiques.',
            category: 'token-sale',
            jurisdiction: 'eu',
        ...
        },
        {
            ...
            description: 'Modèle de contrat pour la mise en place d\'une structure de gouvernance décentralisée (DAO), définissant les droits de vote, les processus de proposition et les mécanismes de décision.',
            category: 'governance',
            jurisdiction: 'global',
        ...
        },
        {
            ...
            description: 'Document détaillant les procédures de Know Your Customer (KYC) et Anti-Money Laundering (AML) conformes aux réglementations européennes, incluant AMLD5 et MiCA.',
            category: 'compliance',
            jurisdiction: 'eu',
        ...
        },
        {
            ...
            description: 'Politique de confidentialité conforme au RGPD pour les projets blockchain, abordant les spécificités liées à l\'immuabilité des données et aux transactions pseudonymes.',
            category: 'privacy',
            jurisdiction: 'eu',
        ...
        },
        {
            ...
            description: 'Modèle de contrat de licence définissant les droits accordés aux acheteurs de NFT, incluant les droits d\'utilisation, de revente et de propriété intellectuelle.',
        ...
        },
        {
            ...
            description: 'Conditions d\'utilisation pour les plateformes DeFi, couvrant les risques spécifiques, les responsabilités des utilisateurs et les clauses de limitation de responsabilité.',
            category: 'terms',
            jurisdiction: 'global',
        ...
        },
        {
            ...
            description: 'Modèle de divulgation des risques et des informations réglementaires à inclure dans un whitepaper de projet blockchain, conforme aux exigences de la SEC.',
            category: 'compliance',
            jurisdiction: 'us',
        ...
        },
        {
            ...
            description: 'Modèle de contrat pour l\'engagement d\'un développeur ou d\'une équipe pour créer des smart contracts, incluant les clauses de propriété intellectuelle, de garantie et de responsabilité.',
            category: 'intellectual-property',
            jurisdiction: 'global',
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">
                            Des modèles juridiques professionnels pour sécuriser votre projet blockchain
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {filteredTemplates.length > 0 ? (
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                                            <div>
                                                ...
                                                <span className="font-medium text-gray-900 dark:text-white">{template.format}</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500 dark:text-gray-400">Juridiction: </span>
                                                <span className="font-medium text-gray-900 dark:text-white">
                                                    {jurisdictions.find(j => j.id === template.jurisdiction)?.name || template.jurisdiction}
                                                </span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500 dark:text-gray-400">Mise à jour: </span>
                                                <span className="font-medium text-gray-900 dark:text-white">{template.lastUpdated}</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500 dark:text-gray-400">Téléchargements: </span>
                                                <span className="font-medium text-gray-900 dark:text-white">{template.downloadCount}</span>
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <button
                                                className={`px-4 py-2 rounded-md text-white text-sm font-medium ${template.premium
                            ...
                            <div className="col-span-full text-center py-12">
                                ...
                                <h3 className="mt-2 text-lg font-medium text-gray-900 dark:text-white">Aucun modèle trouvé</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                                ...
                                <p className="text-blue-700 dark:text-blue-200 mb-4">
                                    Nos experts juridiques peuvent adapter n'importe quel modèle de notre bibliothèque à vos besoins spécifiques et à votre juridiction.
                                </p>
                            ...
                            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6">
                                ...
                                <p className="text-purple-700 dark:text-purple-200 mb-4">
                                    Obtenez des conseils juridiques personnalisés de la part d'avocats spécialisés en droit des technologies et de la blockchain.
                                </p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                                    Les modèles sont-ils à jour avec les dernières réglementations?
                                </h3>
                                <p className="mt-1 text-gray-600 dark:text-gray-400">
                                    Oui, tous nos modèles sont régulièrement mis à jour pour refléter les dernières évolutions réglementaires. La date de dernière mise à jour est indiquée sur chaque modèle.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                                    Puis-je utiliser ces modèles pour mon projet sans consultation juridique?
                                </h3>
                                <p className="mt-1 text-gray-600 dark:text-gray-400">
                                    Nos modèles sont conçus pour servir de base solide, mais nous recommandons toujours une consultation avec un avocat pour les adapter à votre situation spécifique. Les modèles ne constituent pas un avis juridique.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                                    Quelle est la différence entre les modèles gratuits et premium?
                                </h3>
                                <p className="mt-1 text-gray-600 dark:text-gray-400">
                                    Les modèles premium sont plus détaillés, couvrent des cas d'usage plus spécifiques et sont rédigés par des cabinets d'avocats de premier plan. Ils incluent également des annotations explicatives et des options alternatives pour différents scénarios.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                                ...
                                <p className="mt-1 text-gray-600 dark:text-gray-400">
                                    Tous les modèles sont disponibles en format DOCX éditable. Un aperçu en PDF est également disponible pour consultation avant téléchargement ou achat.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                                    Comment puis-je demander un modèle qui n'est pas dans la bibliothèque?
                                </h3>
                                <p className="mt-1 text-gray-600 dark:text-gray-400">
                                    Vous pouvez contacter notre équipe juridique via le formulaire de contact ou en utilisant l'option "Demander un modèle personnalisé" dans votre espace membre. Nous évaluerons votre demande et vous proposerons une solution adaptée.
                                </p>
                            </div>
                        </div>
                    </div>
