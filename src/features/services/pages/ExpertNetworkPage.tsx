    ...
    const experts = [
        {
            ...
            verified: true,
            description: "Économiste spécialisée en tokenomics avec plus de 8 ans d'expérience dans la conception de modèles économiques pour des projets blockchain. Anciennement chez Binance et ConsenSys.",
            projects: 34,
            completionRate: 98
        },
        {
            ...
            verified: true,
            description: "Spécialiste en sécurité blockchain avec une expertise particulière dans l'audit de smart contracts et la prévention des vulnérabilités. A travaillé sur plus de 50 audits de sécurité pour des projets majeurs.",
            projects: 53,
            completionRate: 100
        },
        {
            ...
            verified: true,
            description: "Développeuse Solidity avec 5 ans d'expérience dans la création de tokens et protocoles DeFi. Contributrice active à plusieurs projets open-source et créatrice de bibliothèques Solidity populaires.",
            projects: 29,
            completionRate: 97
        },
        {
            ...
            verified: true,
            description: "Expert en solutions multi-chain et interopérabilité blockchain. Spécialisé dans la conception et l'implémentation de bridges cross-chain et la synchronisation de données entre différentes blockchains.",
            projects: 22,
            completionRate: 95
        },
        {
            ...
            availability: "Disponible maintenant",
            verified: true,
            description: "Spécialiste en marketing et stratégie de lancement pour projets crypto. A accompagné plus de 30 projets dans leur stratégie de go-to-market, construction communautaire et relations avec les investisseurs.",
            projects: 31,
            completionRate: 94
        },
        {
            ...
            verified: true,
            description: "Avocat spécialisé dans la réglementation des crypto-actifs et la conformité. Conseille les projets sur les aspects juridiques du lancement de tokens et les exigences réglementaires dans différentes juridictions.",
            projects: 45,
            completionRate: 99
        }
    ];
    ...
    const testimonials = [
        {
            ...
            expertName: "Dr. Sarah Chen",
            rating: 5,
            comment: "Dr. Chen a complètement transformé notre approche de tokenomics. Ses conseils nous ont permis d'éviter plusieurs pièges courants et d'optimiser notre modèle économique. Un investissement qui a largement porté ses fruits!",
            date: "Février 2025"
        },
        {
            id: 202,
            ...
            expertName: "Alex Moreau",
            rating: 5,
            comment: "L'audit de sécurité réalisé par Alex a été extrêmement approfondi. Il a identifié plusieurs vulnérabilités que nous n'avions pas détectées et nous a fourni des solutions claires. Très professionnel et réactif.",
            date: "Janvier 2025"
        },
        {
            id: 203,
            ...
            rating: 4,
            comment: "Maria a développé notre token en un temps record tout en maintenant une qualité exceptionnelle. Son expertise en Solidity est impressionnante et elle a su adapter le code à nos besoins spécifiques.",
            date: "Décembre 2024"
        }
    ];
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 6 }}>
            ...
            <Typography variant="h6" align="center" color="textSecondary" paragraph sx={{ mb: 6 }}>
                Connectez-vous avec des experts certifiés pour vous accompagner dans votre projet blockchain
            </Typography>
                                    ...
                                    <CardContent sx={{ flexGrow: 1 }}>
                                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                            ...
                                            <IconButton
                                                ...
                                                color={favoriteExperts.includes(expert.id) ? "primary" : "default"}
                                            >
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                            ...
                                            <Typography variant="body2" color={expert.availability.includes("maintenant") ? "success.main" : "text.secondary"}>
                                                {expert.availability}
                                            </Typography>
                                        </Box>
                                        <Box sx={{ mb: 2 }}>
                        ...
                        <Grid container spacing={3}>
                            {recentBookings.map((booking) => (
                                <Grid item xs={12} sm={6} key={booking.id}>
                                    <Paper sx={{ p: 3, borderLeft: 4, borderColor: booking.status === "Confirmé" ? "success.main" : "warning.main" }}>
                                        <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                                            <Avatar src={booking.expertAvatar} sx={{ width: 60, height: 60, mr: 2 }} />
                                            <Box sx={{ flexGrow: 1 }}>
                                                ...
                                                <Chip
                                                    ...
                                                    size="small"
                                                    color={booking.status === "Confirmé" ? "success" : "warning"}
                                                    sx={{ mt: 1 }}
                                                />
                                            </Box>
                                        </Box>
                                ...
                                <Card>
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" paragraph>
                                            Évaluation préliminaire de la sécurité de votre smart contract avant déploiement
                                        </Typography>
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                            <AccessTime fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                            <Typography variant="body2">
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                <Card>
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" paragraph>
                                            Analyse et optimisation de votre modèle économique pour assurer la viabilité à long terme
                                        </Typography>
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                            <AccessTime fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                            <Typography variant="body2">
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                <Card>
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" paragraph>
                                            Planification complète du lancement de votre token pour maximiser l'impact et l'adoption
                                        </Typography>
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                            <AccessTime fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                            <Typography variant="body2">
                    ...
                    <Grid container spacing={4}>
                        {testimonials.map((testimonial) => (
                            <Grid item xs={12} key={testimonial.id}>
                                <Paper sx={{ p: 3 }}>
                                    <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                                        <Avatar src={testimonial.clientAvatar} sx={{ width: 60, height: 60, mr: 2 }} />
                                        <Box sx={{ flexGrow: 1 }}>
                                            <Typography variant="h6" gutterBottom>
                            ...
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={4}>
                                    <Box sx={{ position: 'relative' }}>
                                        <CardMedia
                                            component="img"
                                            image={experts.find(e => e.id === selectedExpert)?.avatar}
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                        <StyledRating
                                            value={experts.find(e => e.id === selectedExpert)?.rating}
                                            precision={0.1}
                                            readOnly
                                            size="small"
                                        />
                                        <Typography variant="body2" sx={{ ml: 1 }}>
                                            ({experts.find(e => e.id === selectedExpert)?.reviews} avis)
                                        </Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                        <AttachMoney fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                        <Typography variant="body2">
                                            {experts.find(e => e.id === selectedExpert)?.hourlyRate} / heure
                                        </Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                        <LocationOn fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                        <AccessTime fontSize="small" color="action" sx={{ mr: 0.5 }} />
                                        <Typography variant="body2" color={experts.find(e => e.id === selectedExpert)?.availability.includes("maintenant") ? "success.main" : "text.secondary"}>
                                            {experts.find(e => e.id === selectedExpert)?.availability}
                                        </Typography>
                                    </Box>
                                    <Divider sx={{ my: 2 }} />
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        {experts.find(e => e.id === selectedExpert)?.languages.map((language) => (
                                            <Chip
                                                key={language}
                                                label={language}
                                                size="small"
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        {experts.find(e => e.id === selectedExpert)?.specialties.map((specialty) => (
                                            <Chip
                                                key={specialty}
                                                label={specialty}
                                                size="small"
                                ...
                                <Grid item xs={12} md={8}>
                                    ...
                                    <Grid container spacing={2} sx={{ mb: 3 }}>
                                        <Grid item xs={6} sm={3}>
                                            <Paper sx={{ p: 2, textAlign: 'center' }}>
                                                <Typography variant="h4" color="primary">
                                                    {experts.find(e => e.id === selectedExpert)?.projects}
                                                </Typography>
                                        ...
                                        <Grid item xs={6} sm={3}>
                                            <Paper sx={{ p: 2, textAlign: 'center' }}>
                                                <Typography variant="h4" color="primary">
                                                    {experts.find(e => e.id === selectedExpert)?.completionRate}%
                                                </Typography>
                                    ...
                                    <Paper sx={{ p: 2, mb: 3 }}>
                                        <Typography variant="body2" paragraph>
                                            Sélectionnez une date et une heure pour réserver une consultation avec cet expert.
                                        </Typography>
                                    ...
                                    <List>
                                        <ListItem>
                                            <ListItemText
                                                ...
                                                secondary={`${experts.find(e => e.id === selectedExpert)?.hourlyRate} • Évaluation de votre projet et recommandations`}
                                            />
                                        ...
                                        <ListItem>
                                            <ListItemText
                                                ...
                                                secondary={`À partir de ${parseInt(experts.find(e => e.id === selectedExpert)?.hourlyRate || "0") * 3}€ • Analyse détaillée et rapport complet`}
                                            />
                                            <Button variant="contained" color="primary" size="small">
                                                Réserver
                                            </Button>
