...
import {
  MarketingConfig as IMarketingConfig,
  ServiceType,
} from "../types/services";
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormGroup>
            ...
            <TextArea
              ...
              {...register("description", {
                ...
                minLength: {
                  value: 100,
                  message: "La description doit faire au moins 100 caractères",
                },
              })}
        ...
        <Section>
          ...
          <FormGroup>
            ...
            <Input
              id="prType"
              {...register("prCampaign.type", {
                required: "Le type de communiqué est requis",
              })}
