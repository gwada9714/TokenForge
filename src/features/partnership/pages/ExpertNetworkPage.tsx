      ...
      projects: [
        {
          name: "DeFiChain",
          description:
            "Conception du modèle économique et des mécanismes d'incitation pour une plateforme DeFi majeure.",
        },
        {
          name: "GreenToken",
          description:
            "Développement d'un système de tokenomics pour un projet de compensation carbone sur blockchain.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "Sophie a transformé notre projet avec sa vision claire et sa compréhension profonde des mécanismes d'incitation. Hautement recommandée!",
          date: "2025-01-15",
        },
        {
          ...
          rating: 4.8,
          comment:
            "Excellente expertise en tokenomics et très professionnelle. A livré exactement ce dont nous avions besoin.",
          date: "2024-12-10",
        },
      ],
    },
      ...
      projects: [
        {
          name: "SafeVault",
          description:
            "Audit complet de sécurité pour un protocole de prêt DeFi avec plus de 100M$ de TVL.",
        },
        {
          name: "NFT Marketplace",
          description:
            "Développement et audit des contrats intelligents pour une place de marché NFT.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "Thomas a identifié plusieurs vulnérabilités critiques dans nos contrats que d'autres auditeurs avaient manquées. Un vrai professionnel!",
          date: "2025-02-05",
        },
        {
          ...
          rating: 4.7,
          comment:
            "Excellent travail d'audit, rapport détaillé et recommandations claires. Nous travaillerons à nouveau avec Thomas.",
          date: "2024-11-20",
        },
      ],
    },
      ...
      projects: [
        {
          name: "CryptoBank",
          description:
            "Conseil juridique pour l'obtention d'une licence d'établissement de paiement pour une plateforme crypto.",
        },
        {
          name: "TokenOffering",
          description:
            "Structuration juridique complète pour une offre de tokens conforme à la réglementation européenne.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "Camille nous a guidés à travers le labyrinthe réglementaire avec expertise et clarté. Son aide a été inestimable.",
          date: "2025-01-30",
        },
        {
          author: "Pierre Leroy",
          rating: 4.5,
          comment:
            "Excellente connaissance du cadre juridique des cryptomonnaies en Europe. Très réactive et professionnelle.",
          date: "2024-12-15",
        },
      ],
    },
      ...
      projects: [
        {
          name: "YieldMax",
          description:
            "Conception et développement d'un protocole d'optimisation de rendement multi-chaînes.",
        },
        {
          name: "StableLend",
          description:
            "Architecture d'un protocole de prêt basé sur des stablecoins avec mécanismes anti-liquidation innovants.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "Lucas a transformé notre vision en un protocole fonctionnel et innovant. Sa compréhension des mécanismes DeFi est impressionnante.",
          date: "2025-02-10",
        },
        {
          ...
          rating: 4.8,
          comment:
            "Excellent architecte technique avec une vision claire des tendances DeFi. A livré un protocole robuste et bien pensé.",
          date: "2024-11-05",
        },
      ],
    },
      ...
      projects: [
        {
          ...
          description:
            "Stratégie marketing complète pour le lancement d'une collection NFT qui a généré 3M$ de ventes.",
        },
        {
          name: "DeFi Protocol Growth",
          description:
            "Campagne d'acquisition d'utilisateurs pour un protocole DeFi, augmentant la TVL de 200% en 3 mois.",
        },
      ],
      reviews: [
        {
          ...
          rating: 4.7,
          comment:
            "Emma a développé une stratégie marketing qui a parfaitement résonné avec notre public cible. Résultats exceptionnels!",
          date: "2025-01-20",
        },
        {
          ...
          rating: 4.5,
          comment:
            "Approche créative et data-driven. Emma comprend vraiment les spécificités du marketing dans l'espace crypto.",
          date: "2024-12-05",
        },
      ],
    },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">
              Connectez-vous avec des experts blockchain de premier plan pour
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Parcourez notre réseau d'experts vérifiés et trouvez le
                  spécialiste qui correspond à vos besoins.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Planifiez une consultation initiale pour discuter de vos
                  besoins et définir les objectifs de votre collaboration.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Travaillez ensemble sur notre plateforme sécurisée avec
                  paiements garantis et suivi de projet intégré.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-300">
                  "Grâce au réseau d'experts de TokenForge, nous avons pu
                  trouver un spécialiste en tokenomics qui a transformé notre
                  projet. Le processus était simple et la qualité de l'expertise
                  exceptionnelle."
                </p>
                <div className="mt-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-300">
                  "Nous cherchions un expert en sécurité blockchain pour auditer
                  nos smart contracts. En moins de 24h, nous avions trouvé le
                  partenaire idéal via TokenForge. Une collaboration qui
