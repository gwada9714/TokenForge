  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Typography
        ...
        sx={{ mb: 4 }}
      >
        Tout ce que vous devez savoir pour maîtriser la création et la gestion
        de tokens
      </Typography>
      ...
      <Box sx={{ mb: 6 }}>
              ...
              <StyledCard>
                <CardContent>
                  ...
                  <Typography variant="body2" color="textSecondary" paragraph>
                    Spécifications détaillées, références API et documentation
                    des smart contracts
                  </Typography>
                  <List>
                    <ListItem button>
            ...
            <Grid item xs={12} md={4}>
              <StyledCard>
                <CardContent>
                  ...
                  <Typography variant="body2" color="textSecondary" paragraph>
                    Guides de sécurité, meilleures pratiques et conseils
                    d'experts
                  </Typography>
                  <List>
                    <ListItem button>
            ...
            <Grid item xs={12} md={4}>
              <StyledCard>
                <CardContent>
                  ...
                  <Typography variant="body2" color="textSecondary" paragraph>
                    Conception économique, modèles de distribution et stratégies
                    de croissance
                  </Typography>
                  <List>
                    <ListItem button>
        ...
        {tabValue === 2 && (
          <Box>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography variant="body2">
                  TokenForge supporte actuellement 6 blockchains majeures:
                  Ethereum, Binance Smart Chain (BSC), Polygon, Avalanche,
                  Solana et Arbitrum. Nous ajoutons régulièrement de nouvelles
                  blockchains en fonction des demandes de la communauté et des
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography variant="body2">
                  Notre système Anti-Rugpull combine plusieurs mécanismes de
                  sécurité: verrouillage automatique de liquidité, timelock sur
                  les fonctions critiques, limitations de vente pour les wallets
                  fondateurs, et transparence totale des transactions. Ces
                  mesures combinées rendent pratiquement impossible l'exécution
                  d'un rugpull et garantissent la sécurité des investisseurs.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography variant="body2">
                  Les frais de TokenForge sont en moyenne 20-40% inférieurs à
                  ceux de nos concurrents. Ils se composent des frais de gas
                  (variables selon la blockchain) et des frais de service
                  (dépendant du plan choisi). Vous pouvez utiliser notre
                  calculateur de coûts pour obtenir une estimation précise en
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography variant="body2">
                  Certains paramètres peuvent être modifiés après le
                  déploiement, comme les limites de transaction, les taux de
                  taxation, ou les adresses de distribution. Cependant, les
                  paramètres fondamentaux comme le nom, le symbole ou le supply
                  maximum ne peuvent généralement pas être modifiés une fois le
                  contrat déployé. C'est pourquoi nous recommandons de bien
                  vérifier tous les paramètres avant le déploiement final.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography variant="body2">
                  Notre système de staking permet aux détenteurs de tokens de
                  verrouiller leurs actifs pour recevoir des récompenses. Vous
                  pouvez configurer différents pools avec des périodes et des
                  taux de récompense variables. Le système est entièrement
                  personnalisable et peut être adapté à différents modèles
                  économiques, que ce soit pour la fidélisation, la gouvernance
                  ou l'incitation à long terme.
                </Typography>
              </AccordionDetails>
            </Accordion>
        ...
        {tabValue === 3 && (
          <Box>
            ...
            <Typography variant="body2" color="textSecondary" paragraph>
              Solutions aux problèmes les plus courants rencontrés lors de la
