                    ...
                    <Box sx={{ textAlign: "right", minWidth: 100 }}>
                      ...
                      >
                        ...
                        <Typography
                          variant="body2"
                          color={
                            token.change24h > 0 ? "success.main" : "error.main"
                          }
                        >
          ...
          <Paper sx={{ p: 3, mb: 4 }}>
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
              {quickActions.map((action) => (
                <Grid item xs={6} key={action.id}>
                  ...
                  >
                    <Box sx={{ mb: 1, color: action.color }}>{action.icon}</Box>
            ...
            <Box sx={{ textAlign: "center", mb: 3 }}>
              ...
              <Typography variant="body2" paragraph>
                Scannez ce QR code pour télécharger l'application mobile
                TokenForge
              </Typography>
            ...
            <Typography variant="body2" color="textSecondary" paragraph>
              Recevez des alertes en temps réel sur les mouvements de prix, les
              transactions importantes et les événements de sécurité.
            </Typography>
