    ...
    <Box sx={{ p: 4, maxWidth: 1200, mx: "auto" }}>
      <Card sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Ce composant permet de tester les opérations CRUD de Firestore et les
          requêtes de base. Attention : ces tests créent des données temporaires
          dans votre base Firestore.
        </Typography>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("createDocument", FirestoreTest.testCreateDocument)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("readDocument", FirestoreTest.testReadDocument)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("updateDocument", FirestoreTest.testUpdateDocument)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("deleteDocument", FirestoreTest.testDeleteDocument)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("queryCollection", FirestoreTest.testQueryCollection)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading}
              onClick={() =>
                runTest("firestoreBatch", FirestoreTest.testFirestoreBatch)
              }
            >
              Tester les batches
            </Button>
            ...
            <Button
              ...
              onClick={() =>
                runTest(
                  ...
                  FirestoreTest.testFirestoreTransaction
                )
              }
            >
