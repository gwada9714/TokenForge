    ...
    <Box sx={{ p: 4, maxWidth: 1200, mx: "auto" }}>
      <Card sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Ce composant permet de tester les règles de sécurité Firestore pour
          différents types d'utilisateurs et d'opérations.
        </Typography>
        ...
        <Typography variant="h6" gutterBottom>
          Tests pour utilisateurs anonymes:
        </Typography>
        <Grid container spacing={2} sx={{ mb: 3 }}>
          <Grid item xs={12} md={6}>
            <Button
              ...
              onClick={() =>
                runTest(
                  "anonymousRead",
                  FirestoreSecurityTest.testAnonymousRead
                )
              }
            >
          ...
          <Grid item xs={12} md={6}>
            <Button
              ...
              onClick={() =>
                runTest(
                  "anonymousCspViolation",
                  FirestoreSecurityTest.testAnonymousCspViolation
                )
              }
            >
        ...
        <Typography variant="h6" gutterBottom>
          Tests pour utilisateurs authentifiés:
        </Typography>
        <Grid container spacing={2} sx={{ mb: 3 }}>
          <Grid item xs={12} md={4}>
            <Button
              ...
              onClick={() =>
                runTest(
                  "userProfile",
                  FirestoreSecurityTest.testAuthenticatedUserProfile
                )
              }
            >
              Tester accès profil
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              disabled={isLoading || !isAuthenticated}
              onClick={() =>
                runTest("walletAccess", FirestoreSecurityTest.testWalletAccess)
              }
            >
          ...
          <Grid item xs={12} md={4}>
            <Button
              ...
              onClick={() =>
                runTest(
                  "otherUserAccess",
                  FirestoreSecurityTest.testOtherUserAccess
                )
              }
            >
        ...
        {!isAuthenticated && (
          <Alert severity="info" sx={{ mb: 3 }}>
            Vous devez être authentifié pour exécuter les tests d'utilisateurs
            authentifiés.
          </Alert>
        )}
