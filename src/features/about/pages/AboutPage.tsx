        ...
        <section className="mb-12">
          ...
          <div className="prose max-w-none">
            <p className="text-lg mb-4">
              TokenForge est né d'une vision simple : rendre la création et le
              déploiement de tokens accessibles à tous, quelle que soit leur
              expertise technique.
            </p>
            <p className="mb-6">
              Notre plateforme combine simplicité d'utilisation, sécurité
              avancée et tarifs compétitifs pour démocratiser l'accès à la
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p>
                Un monde où la création de tokens est aussi simple que la
                création d'un site web, permettant à chacun de participer à
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p>
                Démocratiser la création de tokens en fournissant des outils
                simples, sécurisés et abordables, tout en éduquant les
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm mb-3">
                Expert blockchain avec 8 ans d'expérience dans le développement
                de smart contracts.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm mb-3">
                Architecte blockchain spécialisée en sécurité et optimisation
                des smart contracts.
              </p>
              <div className="flex justify-center space-x-3">
                <a href="#" className="text-blue-600 hover:text-blue-800">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm mb-3">
                Expert en UX/UI avec une passion pour rendre les technologies
          ...
          <div className="relative border-l-4 border-blue-500 pl-6 ml-6">
            <div className="mb-8 relative">
              ...
              <h3 className="text-xl font-semibold">
                2022 - Lancement de l'idée
              </h3>
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                Frustré par la complexité et le coût élevé des solutions
                existantes, notre fondateur a commencé à développer un prototype
                de TokenForge.
              </p>
            </div>
            <div className="mb-8 relative">
              <div className="absolute -left-10 mt-1.5 h-4 w-4 rounded-full bg-blue-500"></div>
              <h3 className="text-xl font-semibold">
                2023 - Première version beta
              </h3>
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                Après des mois de développement, la première version beta a été
                lancée, permettant la création de tokens sur Ethereum et BSC.
              </p>
            </div>
            <div className="mb-8 relative">
              <div className="absolute -left-10 mt-1.5 h-4 w-4 rounded-full bg-blue-500"></div>
              <h3 className="text-xl font-semibold">
                2024 - Lancement officiel
              </h3>
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                TokenForge est officiellement lancé avec le support de 6
                blockchains et des fonctionnalités avancées de sécurité et de
                tokenomics.
              </p>
            </div>
            <div className="relative">
              <div className="absolute -left-10 mt-1.5 h-4 w-4 rounded-full bg-blue-500"></div>
              <h3 className="text-xl font-semibold">
                2025 - Expansion et innovation
              </h3>
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                Aujourd'hui, nous continuons d'innover avec de nouvelles
                fonctionnalités, plus de blockchains supportées et une
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="mb-4">
                Nous nous engageons à fournir les solutions les plus sécurisées
                possibles, avec des audits réguliers et des mécanismes
                anti-rugpull intégrés.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="mb-4">
                Nous croyons en une transparence totale sur nos opérations, nos
                tarifs et les fonctionnalités de notre plateforme.
              </p>
              <ul className="list-disc pl-5 space-y-2">
