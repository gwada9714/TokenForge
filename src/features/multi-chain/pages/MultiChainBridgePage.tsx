                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">
                            Transférez vos tokens entre différentes blockchains de manière sécurisée et rapide.
                        </p>
                    </div>
                                ...
                                {txHash ? (
                                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
                                        ...
                                        <p className="mt-2 text-sm text-green-700 dark:text-green-200">
                                            Votre transfert a été initié avec succès. Vous pouvez suivre la progression
                                    ...
                                    <form onSubmit={handleTransfer}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    {sourceChain &&
                                                        chainTokens[sourceChain as keyof typeof chainTokens].map((t) => (
                                                ...
                                                <div className="relative">
                                                    ...
                                                    {token && (
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                                const selectedToken = chainTokens[sourceChain as keyof typeof chainTokens].find(
                                                                    (t) => t.symbol === token
                                                                );
                                                                if (selectedToken) {
                                        ...
                                        {sourceChain && targetChain && sourceChain !== targetChain && (
                                            <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4 mb-6">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    <div>
                                                        <span className="text-gray-500 dark:text-gray-400">Frais de bridge:</span>
                                                        <span className="ml-2 text-gray-900 dark:text-white">
                                                            {
                                                                supportedChains.find((c) => c.id === sourceChain)?.fee ||
                                                                '0.1%'
                                                            }
                                                        </span>
                                                    </div>
                                        ...
                                        <div className="flex justify-end">
                                            <button
                                                ...
                                                className={`px-6 py-3 rounded-md text-white font-medium ${isLoading ||
                                                        !amount ||
                                                        !token ||
                                                        sourceChain === targetChain
