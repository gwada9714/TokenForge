...
export const ChainVotingSystem: React.FC = () => {
  ...
  const [chains, setChains] = useState<ChainVote[]>([
    {
      ...
      name: "Arbitrum",
      description:
        "Solution de scaling Layer 2 pour Ethereum avec des frais réduits et une sécurité élevée.",
    ...
    },
    {
      ...
      name: "Optimism",
      description:
        "Layer 2 Ethereum utilisant des Optimistic Rollups pour des transactions rapides et économiques.",
    ...
    },
    {
      ...
      name: "Base",
      description:
        "Layer 2 développé par Coinbase, offrant une expérience utilisateur simplifiée.",
    ...
    },
    {
      ...
      name: "Avalanche",
      description:
        "Plateforme blockchain rapide et économe en énergie avec une finalité quasi instantanée.",
    ...
    },
    {
      ...
      name: "Fantom",
      description:
        "Plateforme de contrats intelligents avec des transactions rapides et des frais minimes.",
  ...
  useEffect(() => {
    if (user) {
      ...
      const usedVotes = Object.values(userVotes).filter(
        (voted) => voted
      ).length;
    ...
    <Box sx={{ py: 4 }}>
      ...
      {user && (
        <Alert severity="info" sx={{ mb: 4 }}>
          Vous avez <strong>{remainingVotes}</strong> votes restants.
      ...
      <Grid container spacing={3}>
        {sortedChains.map((chain) => {
          ...
          const votePercentage =
            totalVotes > 0 ? (chain.votes / totalVotes) * 100 : 0;
              ...
              >
                <CardContent>
                  ...
                  {chain.estimatedCompletion && (
                    <Typography variant="body2" sx={{ mb: 2 }}>
                      <strong>Achèvement estimé:</strong>{" "}
                      {chain.estimatedCompletion}
                    </Typography>
                  )}
                ...
                <CardActions>
                  <Button
                    ...
                    disabled={
                      !user || isCompleted || (!isVoted && remainingVotes <= 0)
                    }
                    fullWidth
                  >
                    {isVoted ? "Voté" : "Voter"}
      ...
      <Dialog open={openProposalDialog} onClose={handleCloseProposalDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Proposez une blockchain que vous aimeriez voir intégrée à
            TokenForge. Votre proposition sera soumise au vote de la communauté.
          </DialogContentText>
          <TextField
            autoFocus
            margin="dense"
