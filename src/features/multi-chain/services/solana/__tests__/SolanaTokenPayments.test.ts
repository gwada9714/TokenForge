...
import { mockWallet, createMockConnection, mockSuccessfulTransaction, mockTransactionError, mockTimeoutError, mockNetworkError, mockValidationError } from './solana-mocks';
...
describe('SolanaTokenPayments', () => {
  ...
  describe('payment execution', () => {
    it('should process payment successfully', async () => {
      ...
      expect(PaymentSessionService.getInstance().updateSessionStatus).toHaveBeenCalledWith(
        expect.any(String),
    ...
    it('should handle transaction errors', async () => {
      ...
      expect(PaymentSessionService.getInstance().updateSessionStatus).toHaveBeenLastCalledWith(
        expect.any(String),
