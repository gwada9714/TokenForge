...
export function getMockProvider() {
  const mockProviderImpl = {
    getBalance: vi.fn().mockResolvedValue(BigNumber.from('1000000000000000000')),
  ...
  const realProvider = new providers.JsonRpcProvider('https://polygon-rpc.com', { name: 'matic', chainId: 137 });
