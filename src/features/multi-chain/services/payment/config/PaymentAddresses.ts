...
export const DEFAULT_RECEIVER_ADDRESS = '0xc6E1e8A4AAb35210751F3C4366Da0717510e0f1A' as Address;
...
export function getReceiverAddress(network: PaymentNetwork): Address | PublicKey {
