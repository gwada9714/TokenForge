    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="subtitle1" color="text.secondary" sx={{ mb: 3 }}>
          Lancez votre token avec succès grâce à notre plateforme de launchpad
        ...
        <Paper sx={{ p: 3, mb: 4 }}>
          <Alert severity="info" sx={{ mb: 0 }}>
            ...
            <ul>
              ...
              <li>
                Options de vesting personnalisables pour rassurer les
                investisseurs
              </li>
              <li>Verrouillage automatique de la liquidité</li>
              <li>Visibilité auprès de notre communauté d'investisseurs</li>
              <li>
                Support technique et marketing pendant toute la durée de la
                presale
              </li>
            </ul>
          </Alert>
