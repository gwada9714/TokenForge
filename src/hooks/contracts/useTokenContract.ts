...
export const useTokenContract = () => {
  ...
  const addTokenContract = useCallback(
  ...
  const removeTokenContract = useCallback(
    (address: Address) => {
  ...
  const updateTokenContract = useCallback(
    (address: Address, updates: Partial<TokenContract>) => {
