...
describe('useAuth Hook', () => {
  ...
  it('devrait appeler signIn avec les identifiants corrects', async () => {
    ...
    (firebaseAuth.signIn as ReturnType<typeof vi.fn>).mockResolvedValue(mockUser);
  ...
  it('devrait appeler signUp avec les identifiants corrects', async () => {
    ...
    (firebaseAuth.signUp as ReturnType<typeof vi.fn>).mockResolvedValue(mockUser);
    ...
    expect(firebaseAuth.signUp).toHaveBeenCalledWith('newuser@example.com', 'password');
  });
  ...
  it('devrait appeler signInAnonymously', async () => {
    ...
    (firebaseAuth.signInAnonymously as ReturnType<typeof vi.fn>).mockResolvedValue(mockUser);
  ...
  it('devrait appeler signOut', async () => {
    (firebaseAuth.signOut as ReturnType<typeof vi.fn>).mockResolvedValue(undefined);
  ...
  it('devrait appeler resetPassword avec l\'email correct', async () => {
    (firebaseAuth.resetPassword as ReturnType<typeof vi.fn>).mockResolvedValue(undefined);
  ...
  it('devrait appeler updateUserProfile avec les données correctes', async () => {
    (firebaseAuth.updateProfile as ReturnType<typeof vi.fn>).mockResolvedValue(undefined);
  ...
  it('devrait appeler le callback onAuthStateChanged', async () => {
    ...
    renderHook(() => 
      useAuth({ onAuthStateChanged: onAuthStateChangedMock })
    );
