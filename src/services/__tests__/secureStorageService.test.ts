...
describe('SecureStorageService', () => {
  ...
  describe('setItem', () => {
    it('encrypts and stores data', () => {
      ...
      expect(localStorage.setItem).toHaveBeenCalledWith('testKey', mockEncryptedData);
    });
    ...
    it('handles encryption errors', () => {
      ...
      expect(() => secureStorage.setItem('testKey', mockData)).toThrow('Encryption failed');
    });
  });
  ...
  describe('getItem', () => {
    ...
    it('handles decryption errors', () => {
      ...
      expect(() => secureStorage.getItem('testKey')).toThrow('Decryption failed');
    });
  });
