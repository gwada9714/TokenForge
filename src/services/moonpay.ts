import { MoonPayConfig, MoonPayQuote, MoonPayTransaction } from '../types/moonpay';
...
class MoonPayService {
  ...
  async getQuote(
    ...
    const url = new URL(`${this.config.baseUrl}/v3/currencies/${quoteCurrency}/quote`);
...
export const moonpayService = new MoonPayService({
  ...
  environment: (process.env.REACT_APP_MOONPAY_ENVIRONMENT || 'sandbox') as 'live' | 'sandbox',
});
