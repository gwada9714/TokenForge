...
export const validateTaxConfig = (taxConfig: {
  ...
  if (
    taxConfig.marketingWallet &&
    !validateAddress(taxConfig.marketingWallet)
  ) {
    errors.marketingWallet = "Adresse de portefeuille marketing invalide";
  }

  if (
    taxConfig.developmentWallet &&
    !validateAddress(taxConfig.developmentWallet)
  ) {
    errors.developmentWallet =
      "Adresse de portefeuille de développement invalide";
  }
