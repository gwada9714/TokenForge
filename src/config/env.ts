...
if (!ENV.SEPOLIA_PRIVATE_KEY) {
  console.warn('⚠️ La clé privée Sepolia n\'est pas configurée dans le fichier .env');
}

if (!ENV.SEPOLIA_RPC_URL) {
  console.warn('⚠️ L\'URL RPC Sepolia n\'est pas configurée dans le fichier .env');
}
