...
class AppLogger implements Logger {
  private formatMessage(level: LogLevel, { category, message, error, metadata }: LoggerMessage): string {
  ...
  debug(message: LoggerMessage): void { this.log('debug', message); }
  info(message: LoggerMessage): void { this.log('info', message); }
  warn(message: LoggerMessage): void { this.log('warn', message); }
  error(message: LoggerMessage): void { this.log('error', message); }
}
