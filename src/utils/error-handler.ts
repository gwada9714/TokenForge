    ...
    if (errorCode.startsWith('auth/')) {
      switch (errorCode) {
        ...
        case 'auth/user-not-found':
          userFriendlyMessage = 'Aucun compte ne correspond à cette adresse e-mail.';
          break;
        case 'auth/wrong-password':
          userFriendlyMessage = 'Le mot de passe est incorrect.';
          break;
        case 'auth/weak-password':
          userFriendlyMessage = 'Le mot de passe est trop faible. Il doit contenir au moins 6 caractères.';
          break;
        case 'auth/requires-recent-login':
          userFriendlyMessage = 'Cette opération est sensible et nécessite une authentification récente. Veuillez vous reconnecter.';
          break;
        default:
    ...
    // Erreurs Firestore
      ...
      switch (errorCode) {
        case 'firestore/permission-denied':
          userFriendlyMessage = 'Vous n\'avez pas les permissions nécessaires pour accéder à cette ressource.';
          break;
        case 'firestore/not-found':
          userFriendlyMessage = 'Le document demandé n\'existe pas.';
          break;
        case 'firestore/already-exists':
          userFriendlyMessage = 'Le document que vous essayez de créer existe déjà.';
          break;
        case 'firestore/failed-precondition':
          userFriendlyMessage = 'L\'opération a échoué car les conditions préalables ne sont pas remplies.';
          break;
        ...
        case 'firestore/deadline-exceeded':
          userFriendlyMessage = 'L\'opération a pris trop de temps à s\'exécuter.';
          break;
        case 'firestore/resource-exhausted':
          userFriendlyMessage = 'Les ressources système sont épuisées.';
          break;
        case 'firestore/unavailable':
          userFriendlyMessage = 'Le service Firestore est temporairement indisponible. Veuillez réessayer plus tard.';
          break;
        default:
    ...
    // Erreurs de stockage
      ...
      switch (errorCode) {
        ...
        case 'storage/unauthorized':
          userFriendlyMessage = 'Vous n\'avez pas les autorisations nécessaires pour accéder à ce fichier.';
          break;
