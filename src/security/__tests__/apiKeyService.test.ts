...
describe('API Key Service', () => {
  ...
  describe('generateApiKey', () => {
    it('generates valid API key', async () => {
      ...
      const apiKey = await apiKeyService.generateApiKey('Test Key', permissions);
    ...
    it('validates required permissions', async () => {
      ...
      await expect(apiKeyService.generateApiKey('Test Key', invalidPermissions))
    ...
    it('prevents duplicate key names', async () => {
      ...
      await expect(apiKeyService.generateApiKey('Test Key', permissions))
        .rejects.toThrow(TokenForgeError);
    });
  });
  ...
  describe('getApiKeyPermissions', () => {
    it('retrieves API key permissions', async () => {
      ...
      const permissions = await apiKeyService.getApiKeyPermissions('tk_1234567890abcdef1234567890abcdef');
  ...
  describe('revokeApiKey', () => {
    ...
    it('handles non-existent key revocation', async () => {
      ...
      await expect(apiKeyService.revokeApiKey('tk_1234567890abcdef1234567890abcdef'))
        .rejects.toThrow(TokenForgeError);
    });
  });
  ...
  describe('updateApiKeyPermissions', () => {
    ...
    it('prevents admin permission escalation', async () => {
      ...
      await expect(apiKeyService.updateApiKeyPermissions(apiKey, newPermissions))
        .rejects.toThrow(TokenForgeError);
    });
    ...
    it('handles non-existent key update', async () => {
      ...
      await expect(apiKeyService.updateApiKeyPermissions(
