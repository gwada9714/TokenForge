        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-gray-50 rounded">
              ...
              <div className={`text-sm ${diagnostics.configPresent ? 'text-green-600' : 'text-red-600'}`}>
                {diagnostics.configPresent ? 'Oui' : 'Non'}
              </div>
            </div>
            <div className="p-3 bg-gray-50 rounded">
              <div className="font-medium">Émulateurs configurés</div>
              <div className={`text-sm ${diagnostics.emulatorsConfigured ? 'text-green-600' : 'text-red-600'}`}>
