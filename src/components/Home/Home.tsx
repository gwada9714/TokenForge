      ...
      <Container maxWidth="lg">
        ...
        >
          <Typography variant="h2" component="h1" gutterBottom>
            TokenForge :{' '}
            <Typography variant="h2" component="span" sx={{ background: 'linear-gradient(to right, orange, red)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Forgez votre Avenir Crypto
            </Typography>
          </Typography>
          <Typography variant="h5" color="text.secondary" paragraph>
            Créez des tokens personnalisés en quelques clics. Notre plateforme combine puissance et simplicité pour vous permettre de forger des tokens sur mesure, en toute sécurité.
          </Typography>
          <Stack
            direction="row"
            spacing={2}
