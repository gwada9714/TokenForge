...
const channels = [
  {
    icon: (
      ...
      >
        <path
          d="M12 20l9-5.25L12 4 3 14.75 12 20z"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M3 14.75L12 20l9-5.25-9-5.25L3 14.75z"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
      </svg>
    ...
    title: "Discord",
    description:
      "Rejoignez notre communauté Discord pour discuter avec d'autres forgerons et obtenir de l'aide en temps réel.",
    stats: [
  ...
  },
  {
    ...
    title: "Twitter",
    description:
      "Suivez-nous sur Twitter pour les dernières actualités, mises à jour et annonces importantes.",
    stats: [
  ...
  },
  {
    ...
    title: "Telegram",
    description:
      "Restez connecté avec notre groupe Telegram pour des discussions et des alertes en temps réel.",
    stats: [
    ...
    <SectionContainer id="community">
      <Content>
        <SectionHeader>
          ...
          <Description>
            Une communauté vibrante de passionnés de crypto, d'innovateurs et de
            builders.
          </Description>
        </SectionHeader>
