...
export const StakingRewards: React.FC<StakingRewardsProps> = ({
  ...
  const handleClaimAll = async () => {
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to claim all rewards"
      );
    } finally {
              ...
              <Box sx={{ mt: 3 }}>
                ...
                >
                  <Typography variant="subtitle1">
                    {claimableRewards.length} récompense(s) disponible(s) pour
                    réclamation
                  </Typography>
                  <Button
                    variant="contained"
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">TKN</InputAdornment>
                    ),
                  }}
                />
              </Grid>
