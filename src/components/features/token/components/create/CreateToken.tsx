...
const PlanSelection = lazy(() => import("./configuration/PlanSelection"));
const TokenConfiguration = lazy(
  () => import("./configuration/TokenConfiguration")
);
const TokenVerification = lazy(
  () => import("./configuration/TokenVerification")
);
const TokenDeployment = lazy(() => import("./configuration/TokenDeployment"));
...
const CreateToken: React.FC = () => {
  ...
  const calculatePrice = useCallback(() => {
    const basePrice =
      tokenConfig.plan === "premium" ? PREMIUM_TIER_PRICE : BASIC_TIER_PRICE;
