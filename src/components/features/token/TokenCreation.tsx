    ...
    <Box sx={{ width: '100%', mt: 4 }}>
      <Paper sx={{ p: 3 }}>
        ...
        <Box sx={{ mt: 2, mb: 2 }}>
          {activeStep === 0 && (
            <Typography>
              Configurez les paramètres de base de votre token comme le nom, le symbole et l&apos;offre totale.
            </Typography>
          )}
          
          {activeStep === 1 && (
            <Typography>
              Configurez les paramètres avancés comme les taxes, les limites de transaction et les adresses de réception.
            </Typography>
          )}
          ...
          {activeStep === 3 && (
            <Typography>
              Déployez votre token sur la blockchain.
            </Typography>
          )}
        </Box>
