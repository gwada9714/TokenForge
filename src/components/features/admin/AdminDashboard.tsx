          ...
          <Box sx={{ mt: 3 }}>
            ...
            <Paper sx={{ p: 3, mb: 3 }}>
              <Typography variant="body1">
                Bienvenue dans le tableau de bord d'administration de
                TokenForge. Utilisez les onglets ci-dessus pour accéder aux
                différentes fonctionnalités d'administration.
              </Typography>
            </Paper>
          </Box>
        );
  ...
  return (
    <AdminErrorBoundary>
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        <AdminTabs value={activeTab} onChange={handleTabChange} />
