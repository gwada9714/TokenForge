...
describe("AuditLogs", () => {
  ...
  describe("Delete Log Functionality", () => {
    it("shows confirmation dialog before deleting log", async () => {
      ...
      expect(
        screen.getByText("Êtes-vous sûr de vouloir supprimer ce log ?")
      ).toBeTruthy();
    });
  ...
  describe("Error Handling", () => {
    it("shows error message when loading logs fails", async () => {
      ...
      expect(
        screen.getByText("Erreur lors du chargement des logs")
      ).toBeTruthy();
    ...
    it("shows error message when deleting log fails", async () => {
      ...
      mockContract.getAuditLogs.mockResolvedValue(mockLogs);
      mockContract.deleteAuditLog.mockRejectedValueOnce(
      ...
      expect(
        screen.getByText("Erreur lors de la suppression du log")
      ).toBeTruthy();
    });
  });
});
