...
import { Button, Typography, Paper, Box, Divider, CircularProgress, Alert } from '@mui/material';
import { testFirestoreTransaction, testFirestoreBatch, runAllFirestoreTests } from '@/lib/firebase/firestore-test';
  ...
  return (
    <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
      ...
      <Typography variant="body2" color="text.secondary" paragraph>
        Ce composant permet de tester les fonctionnalités avancées de Firestore comme les transactions et les batches.
      </Typography>
