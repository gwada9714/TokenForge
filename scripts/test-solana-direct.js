...
import {
  ...
  SolanaTokenService,
} from "../src/blockchain/adapters/solana.js";
...
async function testSolanaAdapter() {
  ...
  try {
    ...
    log(
      `✅ Validation: ${validationResult.valid ? "OK" : "NON"}`,
      validationResult.valid ? colors.green : colors.red
    );
