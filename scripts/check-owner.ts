...
const ALCHEMY_URL = 'https://eth-sepolia.g.alchemy.com/v2/2Hh69JPgmt2mh7xrbBJM0Fx3ewTox3n7';
...
async function main() {
  ...
  try {
    ...
    console.log('Is owner?', owner.toLowerCase() === '0xc6E1e8A4AAb35210751F3C4366Da0717510e0f1A'.toLowerCase());
