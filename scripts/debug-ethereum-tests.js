...
console.log('Vérification du fichier ethereum.ts:', fs.existsSync(ethereumPath));
...
const { EthereumBlockchainService, EthereumPaymentService, EthereumTokenService } = EthereumModule;
...
async function testPaymentVerification() {
    ...
    try {
        ...
        console.log('\nTest avec une transaction invalide:');
        const invalidResult = await service.verifyPayment('0xinvalidtransactionhash');
