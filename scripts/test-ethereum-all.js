...
async function testEthersConnection() {
    ...
    try {
        ...
        console.log('Timestamp du dernier bloc:', new Date(block.timestamp * 1000).toISOString());
...
async function testViemConnection() {
    ...
    try {
        ...
        console.log('Hash du dernier bloc:', block.hash);
        console.log('Timestamp du dernier bloc:', new Date(Number(block.timestamp) * 1000).toISOString());
        console.log('Transactions dans le dernier bloc:', block.transactions.length);
