// vite.config.ts
import { defineConfig, loadEnv } from "file:///C:/Users/Win10/tokenforge-app/node_modules/vite/dist/node/index.js";
...
var __vite_injected_original_import_meta_url = "file:///C:/Users/Win10/tokenforge-app/vite.config.ts";
...
var cspString = Object.entries(cspConfig).map(([key, values]) => `${key} ${values.join(" ")}`).join("; ");
