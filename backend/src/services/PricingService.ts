...
class PricingService {
   ...
   */
  async calculateTokenCreationPrice(network: string, userId: string): Promise<number> {
  ...
  async getFullPricing(): Promise<{
    ...
    subscriptionPlans: Record<string, { monthly: number, annual: number, features: string[] }>,
