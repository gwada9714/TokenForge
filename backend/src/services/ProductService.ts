...
class ProductService {
  ...
  private marketplaceItems: Record<
    string,
    {
      price: number;
      name: string;
  ...
  > = {
    "token-template-defi": {
      ...
      description:
        "Template de token pour projets DeFi avec fonctionnalités avancées",
      category: "templates",
      author: "TokenForge",
    },
    "token-template-nft": {
      ...
      description:
        "Template de token pour projets NFT avec fonctionnalités de minting",
      category: "templates",
      author: "TokenForge",
    },
    "token-template-dao": {
      ...
      description:
        "Template de token pour projets DAO avec fonctionnalités de gouvernance",
      category: "templates",
      author: "TokenForge",
    },
    "token-template-gaming": {
      ...
      description:
        "Template de token pour projets de jeux avec fonctionnalités de récompenses",
      category: "templates",
      author: "TokenForge",
    },
  };
   ...
   */
  async getAllSubscriptionPlans(): Promise<
    Record<string, { monthly: number; annual: number; features: string[] }>
  > {
   ...
   */
  async getAllPremiumServices(): Promise<
    Record<string, { price: number; description: string }>
  > {
   ...
   */
  async getAllMarketplaceItems(category?: string): Promise<
    Record<
      string,
      {
        price: number;
